  ...
  return (
    ...
    <NavbarAndSidebar>
      <div className={`${style.kotakUtama} mt-4 pb-4 mb-4`}>
        ...
        <h6 className="ms-3 mt-5">Detail Promo Website BDL Mobilindo</h6>
        <div className="d-flex flex-column mx-5 mt-5">
          <div className="row mb-3">
            <label htmlFor="periode" className="col-sm-2 col-form-label">Periode</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="periode" value={periode} disabled/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="judul" className="col-sm-2 col-form-label">Nama Promo</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="judul" value={namaPromo} disabled/>
            </div>
          </div>
          <div class="row mb-3">
