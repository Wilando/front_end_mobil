        ...
        <div className="d-flex flex-column mx-5 mt-5">
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <input type="text" className="form-control" id="namaMobil" value={mobil}/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="tipe" className="col-sm-2 col-form-label">Tipe</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="tipe" value="1.3 E MT"/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="tahun" className="col-sm-2 col-form-label">Tahun</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="tahun" value="2014"/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="transmisi" className="col-sm-2 col-form-label">Tipe Transmisi</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="transmisi" value="Manual Transmission"/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="harga" className="col-sm-2 col-form-label">Harga</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="harga" value={harga}/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="cc" className="col-sm-2 col-form-label">CC</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="cc" value="1329"/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="km" className="col-sm-2 col-form-label">KM</label>
            <div className="col-sm-10">
              <input type="text" className="form-control" id="km" value="936"/>
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="deskripsi" className="col-sm-2 col-form-label">Deskripsi</label>
            <div className="col-sm-10">
              <textarea className="form-control" id="deskripsi" rows="4" value="Pajak On, Mesin Record Dealer, mesin Terawat Halus Seperti Baru, Body Kinclong Tnpa Dempul, Interior Nyaman, Siap Pakai."></textarea>
            </div>
          </div>
          <div className="row mb-3">
