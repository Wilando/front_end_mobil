...
export default function DetailAkun() {
  ...
  const { namaLengkap, username, email } = router.query;
  ...
  return (
    ...
    <NavbarAndSidebar>
      <div className={`${style.kotakUtama} mt-4 pb-4 mb-4`}>
        ...
        <h6 className="ms-3">Detail Akun Pengelola</h6>
        <div className="d-flex flex-column mx-5 mt-5">
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <input type="text" className="form-control" id="namaLengkap" value={nama} 
                onChange={(event)=>{setNama(event.target.value)}} disabled
              />
            </div>
          </div>
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <input type="text" className="form-control" id="username" value={user} 
                onChange={(event)=>{setUser(event.target.value)}} disabled />
            </div>
          </div>
          <div className="row mb-3">
            <label htmlFor="email" className="col-sm-2 col-form-label">Email</label>
            <div className="col-sm-10">
              <input type="email" className="form-control" id="email" value={emailF} 
                onChange={(event)=>{setEmailF(event.target.value)}} disabled />
            </div>
          </div>
          <div className="row mb-3">
