  ...
  return (
    ...
    <NavbarAndSidebar>
      <div className={`${style.kotakUtama} mt-4 pb-4 mb-4`}>
        ...
        <h6 className="ms-3 mt-5">Edit Berita Website BDL Mobilindo</h6>
        <div className="d-flex flex-column mx-5 mt-5">
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <select className="form-select" value={kategori} >
          ...
          <div className="row mb-3">
            ...
            <div className="col-sm-10">
              <input type="text" className="form-control" id="judul" value={judul} />
            </div>
          </div>
          <div className="row mb-3">
